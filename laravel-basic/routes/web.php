...
Route::post('/vendors/store', [VendorController::class, 'store'])->name('vendors.store')->name('vendors.store')->middleware('auth');

Route::get('/vendors/{id}', [VendorController::class, 'show']);

Route::get('/requests/create', [RequestController::class, 'create']);

Route::post('/requests/confirmnpm installnpm install', [RequestController::class, 'confirm'])->name('requests.confirm');
